  ...
  <div class="relative rounded-md shadow-sm">
    ...
    <input
        ...
        :class="[
            ...
            'block w-full rounded-md dark:bg-zinc-800 border-0 py-1.5 ring-1 ring-inset placeholder:text-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:leading-6 sm:text-sm'
        ]"
        v-bind="$attrs"/>
